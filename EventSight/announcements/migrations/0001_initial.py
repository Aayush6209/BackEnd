# Generated by Django 3.1.3 on 2021-03-27 16:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('admin', models.ForeignKey(default=None, on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL)),
                ('followers', models.ManyToManyField(blank=True, related_name='follow_list', to=settings.AUTH_USER_MODEL)),
                ('members', models.ManyToManyField(blank=True, related_name='member_list', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='member_request',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organizers', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='event_organizers', to='announcements.club')),
